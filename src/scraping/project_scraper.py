...
def get_pledges(rewards):
    '''
    Retrieves the project pledge amounts.
...
def count_emb_videos(project):
    '''
    Counts the number of embedded videos on the project page.
    '''
    hosts = ['youtube', 'vimeo']
...
def get_tag(project):
    '''
    Retrieves project categorical tag. This tag is a subcategory tag.
    '''
    try:
...
def get_full_desc(project):
    '''
    Retrieves all text in the project description.
    '''
