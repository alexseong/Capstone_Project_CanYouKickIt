...
# text classification #
## for all categories
    full_tf, full_tf_matrix_train = model_descriptions.get_tf(X_train_d)
    ...
    W_test, full_tf_matrix_test = model_descriptions.get_Wtest(full_tf, X_test_d, nmf)
...
## category film
#     tf, tf_matrix_train = model_descriptions.get_tf(X_train_d)
#     param_grid_d = {'alpha': (1e-2, 1e-3)}
#     nb_d = MultinomialNB()
...
#     W_test, tf_matrix_test = model_descriptions.get_Wtest(tf, X_test_d, nmf)
#
